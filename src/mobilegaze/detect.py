...
from mobilegaze.models import SCRFD
from mobilegaze.config import data_config
from mobilegaze.utils.helpers import get_model, draw_bbox_gaze, draw_bbox_keypoints_gaze
    ...
    with torch.no_grad():
        while True:
            ...
            for bbox, keypoint in zip(bboxes, keypoints):
                ...
                draw_bbox_keypoints_gaze(frame, bbox, keypoint, pitch_predicted, yaw_predicted)
